...
helpMessage =""" ༺•SELF BOT PHET HACK BOT•༻
    ...
    try:
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                cl.sendMessage(msg)
            elif msg.text in ["Joinn on","joinn on","PP on"]:
              if msg.from_ in admin:
                if wait["Protectjoin"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Joinn off","joinn off","PP off"]:
              if msg.from_ in admin:
                if wait["Protectjoin"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Cancl on","cancl on","PK on"]:
              if msg.from_ in admin:
                if wait["Protectcancl"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Cancl off","cancl off","PK off"]:
              if msg.from_ in admin:
                if wait["Protectcancl"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Gr on","gr on","NK on"]:
              if msg.from_ in admin:
                if wait["Protectgr"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Gr off","gr off","NK off"]:
              if msg.from_ in admin:
